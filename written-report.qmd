...
We calculated our RMSE for the final model to be 72.81 base total points, meaning the average base total is 72.81 base total points away from the predicted value of base total points.
...
We calculated our $R^2$ value for the final model to be 0.6284, meaning 62.84% of the variability in base_total is explained by the predictor variables in our final model.
